...
\end{multicols}
 ...
 if (code != null) {
    ...
    \begin{flalign*}
        ...
        V &\to \:\textnormal{Id}\: \:\textnormal{LParen}\: L \:\textnormal{RParen}\: \:\mid\: \:\textnormal{LParen}\: E \:\textnormal{RParen}\: \:\mid\: \:\textnormal{IntLit}\: \:\mid\: \:\textnormal{FloatLit}\: \:\mid\: \:\textnormal{StrLit}\: \:\mid\: \:\textnormal{True}\: \:\mid\: \:\textnormal{False}\: \:\mid\: \:\textnormal{Id}\: &&
    \end{flalign*}
...
V.type = if type == null
    ...
    \end{lstlisting}
    \item $V \to \textnormal{LParen}\: E \:\textnormal{RParen}\:$
    \begin{lstlisting}[language=C]
V.type = E.type
    \end{lstlisting}
...
\newpage
        ...
        \item[syntax.javascript] Fichero con construcciones sintácticas enrevesadas y recursividad.
            \begin{lstlisting}[language=C, basicstyle=\footnotesize]
let int a = 9;

/* el lenguaje es sensible a las mayúsculas */
function int Void(int a) {
    do {
        if (a == a)
            return a;
    } while (!!!(a < a));
...
/* el lenguaje admite recursividad */
function int recursive(int a, float b, string c) {
    return 3 + recursive(
        3 * (implicit + recursive(6,6.0,"6")),
        0.00000000000 * 1.1 * 2.2,
        "."
    );
}
\end{lstlisting}
...
\newpage
                ...
                \textbf{Parse:}
                \begin{lstlisting}[basicstyle=\normalsize]
ascending 19 23 44 47 49 51 53 55 57 25 23 12 15 14 23 7 10 13 59 39 47 49 51 53 55 39 47 49 51 53 56 57 39 47 49 51 53 55 57 18 33 27 5 6 39 47 49 51 53 39 47 49 51 54 55 57 45 47 48 48 48 49 51 53 55 57 24 39 47 49 51 39 47 61 49 52 53 55 57 18 33 28 5 6 6 16 23 12 15 14 23 22 20 7 8 8 10 13 59 44 47 49 51 44 47 49 39 47 49 51 44 47 49 51 53 55 57 43 47 49 51 53 55 57 42 47 49 51 53 55 57 29 30 30 32 46 47 49 52 53 55 57 45 47 50 51 53 55 57 43 47 49 43 47 50 43 47 50 51 53 55 57 42 47 49 51 53 55 57 29 30 30 32 46 47 49 52 53 55 57 18 33 28 5 6 16 2 3 3 4 1
                \end{lstlisting}
...
* lexema: 'a'
  ...
  + despl: 0
* lexema: 'Void'
  + etiqFuncion: '__tag_Void__'
  + tipo: 'function'
    + tipoRetorno: 'int'
    + numParam: 1
      + tipoParam01: 'int'
* lexema: 'recursive'
  + etiqFuncion: '__tag_recursive__'
  + tipo: 'function'
    + tipoRetorno: 'int'
    + numParam: 3
      + tipoParam01: 'int'
...
\begin{multicols}{2}
\begin{figure}[H]
    \includegraphics[width=0.45\textwidth]{images/syntax/vast-1.png}
    \label{fig:syntax-vast-1}
\end{figure}

\begin{figure}[H]
    \includegraphics[width=0.45\textwidth]{images/syntax/vast-2.png}
    \label{fig:syntax-vast-2}
\end{figure}
\end{multicols}
\vspace*{\fill}
\end{center}
...
\begin{multicols}{2}
\begin{figure}[H]
    \includegraphics[width=0.45\textwidth]{images/syntax/vast-3.png}
    \label{fig:syntax-vast-3}
\end{figure}

\begin{figure}[H]
    \includegraphics[width=0.45\textwidth]{images/syntax/vast-4.png}
    \label{fig:syntax-vast-4}
\end{figure}
\end{multicols}
\vspace*{\fill}
\end{center}
...
\begin{multicols}{2}
\begin{figure}[H]
    \includegraphics[width=0.45\textwidth]{images/syntax/vast-5.png}
    \label{fig:syntax-vast-5}
\end{figure}

\begin{figure}[H]
    \includegraphics[width=0.45\textwidth]{images/syntax/vast-6.png}
    \label{fig:syntax-vast-6}
\end{figure}
\end{multicols}
\vspace*{\fill}
\end{center}
...
\begin{multicols}{2}
\begin{figure}[H]
    \includegraphics[width=0.45\textwidth]{images/syntax/vast-7.png}
    \label{fig:syntax-vast-7}
\end{figure}

\begin{figure}[H]
    \includegraphics[width=0.45\textwidth]{images/syntax/vast-8.png}
    \label{fig:syntax-vast-8}
\end{figure}
\end{multicols}
\vspace*{\fill}
\end{center}
...
\newpage
        \item[hard.javascript] Fichero con múltiples \textit{edge cases} tanto sintácticos como semánticos.
            \begin{lstlisting}[language=C, basicstyle=\footnotesize]
read var;

let int a = var + ((23));

function int noreturn(void) {}
...
function int other_scope(float var) {
    var = 5.0;
    var = 6.0;
}

let string mystr = "mystr";

function int last_try(void) {
    implicit = 0;
...
\newpage
                ...
                \textbf{Parse:}
                \begin{lstlisting}[basicstyle=\normalsize]
ascending 34 28 19 23 39 47 49 51 44 47 49 51 53 55 57 45 47 49 51 53 55 57 45 47 49 52 53 55 57 25 23 12 15 14 9 13 59 5 16 11 15 14 9 13 59 17 33 28 17 33 28 17 33 28 5 6 6 6 16 39 47 49 51 53 55 57 35 28 39 47 49 51 39 47 61 60 61 49 52 53 55 57 38 28 23 12 15 14 22 7 10 13 59 43 47 49 51 53 55 57 38 28 43 47 49 51 53 55 57 38 28 5 6 6 16 19 20 42 47 49 51 53 55 57 25 23 12 15 14 9 13 59 44 47 49 51 53 55 57 38 28 19 22 26 43 47 49 51 53 55 57 38 28 5 6 6 6 16 2 3 4 3 4 4 3 3 4 4 1
                \end{lstlisting}
...
* lexema: 'a'
  ...
  + despl: 1
* lexema: 'noreturn'
  + etiqFuncion: '__tag_noreturn__'
  + tipo: 'function'
    + tipoRetorno: 'int'
    + numParam: 0
* lexema: 'noop'
  + etiqFuncion: '__tag_noop__'
  + tipo: 'function'
    + tipoRetorno: 'void'
    + numParam: 0
* lexema: 'implicit'
  ...
  + despl: 2
* lexema: 'other_scope'
  + etiqFuncion: '__tag_other_scope__'
  + tipo: 'function'
    + tipoRetorno: 'int'
    + numParam: 1
      + tipoParam01: 'float'
...
\begin{multicols}{2}
\begin{figure}[H]
    \includegraphics[width=0.45\textwidth]{images/hard/vast-1.png}
    \label{fig:hard-vast-1}
\end{figure}

\begin{figure}[H]
    \includegraphics[width=0.45\textwidth]{images/hard/vast-2.png}
    \label{fig:hard-vast-2}
\end{figure}
\end{multicols}
\vspace*{\fill}
\end{center}
...
\begin{multicols}{2}
\begin{figure}[H]
    \includegraphics[width=0.45\textwidth]{images/hard/vast-3.png}
    \label{fig:hard-vast-3}
\end{figure}

\begin{figure}[H]
    \includegraphics[width=0.45\textwidth]{images/hard/vast-4.png}
    \label{fig:hard-vast-4}
\end{figure}
\end{multicols}
\vspace*{\fill}
\end{center}
...
\begin{multicols}{2}
\begin{figure}[H]
    \includegraphics[width=0.45\textwidth]{images/hard/vast-5.png}
    \label{fig:hard-vast-5}
\end{figure}

\begin{figure}[H]
    \includegraphics[width=0.45\textwidth]{images/hard/vast-6.png}
    \label{fig:hard-vast-6}
\end{figure}
\end{multicols}
\vspace*{\fill}
\end{center}
...
\vspace*{\fill}
\begin{figure}[H]
    \includegraphics[width=1.0\textwidth]{images/hard/vast-7.png}
    \label{fig:hard-vast-7}
\end{figure}
\vspace*{\fill}
\end{center}
    \subsection{Casos Incorrectos}
    \begin{description}
        \item[lexer.javascript] Fichero con errores mayoritariamente léxicos
...
\vspace{-2em}
\begin{figure}[H]
    \includegraphics[width=0.95\textwidth]{images/diags/diags-lexer.png}
    \label{fig:diags-lexer}
\end{figure}
\newpage

        \item[parser.javascript] Fichero con errores mayoritariamente sintácticos
            \begin{lstlisting}[basicstyle=\footnotesize]
...
/* mas sustituciones y eliminaciones */
a == 4;

b = 4,

function int chachi(int) { }
...
\vspace{-2em}
\begin{figure}[H]
    \includegraphics[width=1.0\textwidth]{images/diags/diags-parser-1.png}
    \label{fig:diags-parser-1}
\end{figure}
\newpage
\begin{figure}[H]
    \includegraphics[width=1.0\textwidth]{images/diags/diags-parser-2.png}
    \label{fig:diags-parser-2}
\end{figure}
\newpage

\newpage

        \item[sem.javascript] Fichero con errores mayoritariamente semánticos
            \begin{lstlisting}[basicstyle=\footnotesize]
asdf &= true;
...
\vspace{-2em}
\begin{figure}[H]
    \includegraphics[width=0.95\textwidth]{images/diags/diags-sem-1.png}
    \label{fig:diags-sem-1}
\end{figure}
\newpage
\begin{figure}[H]
    \includegraphics[width=1.0\textwidth]{images/diags/diags-sem-2.png}
    \label{fig:diags-sem-2}
\end{figure}
\newpage

        \item[lex\_plus\_parse.javascript] Fichero con errores mayoritariamente léxicos y sintácticos
            \begin{lstlisting}[basicstyle=\footnotesize]
...
\vspace{-2em}
\begin{figure}[H]
    \includegraphics[width=1.0\textwidth]{images/diags/diags-plus-1.png}
    \label{fig:diags-plus-1}
\end{figure}
\newpage
\begin{figure}[H]
    \includegraphics[width=1.0\textwidth]{images/diags/diags-plus-2.png}
    \label{fig:diags-plus-2}
\end{figure}
\newpage

        \item[challenge.javascript] Fichero con todo tipo de errores
            \begin{lstlisting}[basicstyle=\footnotesize]
let lol_sum = oper();
...
\vspace{-2em}
\begin{figure}[H]
    \includegraphics[width=0.95\textwidth]{images/diags/diags-challenge-1.png}
    \label{fig:diags-challenge-1}
\end{figure}
\newpage
\begin{figure}[H]
    \includegraphics[width=1.0\textwidth]{images/diags/diags-challenge-2.png}
    \label{fig:diags-challenge-2}
\end{figure}
\newpage
    \end{description}
