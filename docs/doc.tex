...
\end{multicols}
 ...
 error("Unterminated string literal")
        ...
        \item[INV\_FLOAT\_FMT] Si en el estado $19$ no se puede transitar
            \begin{lstlisting}[language=C]
 error("Invalid float literal format")
            \end{lstlisting}
 ...
 if (code != null) {
    ...
    \begin{flalign*}
        ...
        N &= \{ E_1, R_1, R_2, U_1, U_2, E_2, V, S, L, Q, X, B, T, M, F, F_1, F_2, F_3, H, A, K, C, P \} &&
    \end{flalign*}
    ...
    \begin{flalign*}
        ...
        C &\to B C \:\mid\: \lambda && \\
        F &\to \:\textnormal{Func}\: F_1 F_2 F_3 \:\textnormal{LBrack}\: C \:\textnormal{RBrack}\: && \\
        F_1 &\to H && \\
        F_2 &\to \:\textnormal{Id}\: && \\
        F_3 &\to \:\textnormal{LParen}\: A \:\textnormal{RParen}\: && \\
        ...
        B &\to S \:\mid\: \:\textnormal{Let}\: M T \:\textnormal{Id}\: \:\textnormal{Semi}\: \:\mid\: \:\textnormal{Let}\: M T \:\textnormal{Id}\: \:\textnormal{Assign}\: E \:\textnormal{Semi}\: \:\mid\: \:\textnormal{Let}\: M T \:\textnormal{Id}\: \:\textnormal{AndAssign}\: E \:\textnormal{Semi}\: && \\
        M &\to \lambda && \\
        ...
        X &\to E \:\mid\: \lambda && \\
        E_1 &\to E_1 \:\textnormal{And}\: R_1 \:\mid\: R_1 && \\
        R_1 &\to R_1 \:\textnormal{Eq}\: R_2 \:\mid\: R_2 && \\
        R_2 &\to R_2 \:\textnormal{Lt}\: U_1 \:\mid\: U_1 && \\
        U_1 &\to U_1 \:\textnormal{Sum}\: U_2 \:\mid\: U_2 && \\
        U_2 &\to U_2 \:\textnormal{Mul}\: E_2 \:\mid\: E_2 && \\
        E_2 &\to \:\textnormal{Not}\: E_2 \:\mid\: \:\textnormal{Sub}\: E_2 \:\mid\: \:\textnormal{Sum}\: E_2 \:\mid\: V && \\
    ...
    De este modo, un fichero fuente sintácticamente correcto se puede interpretar como una palabra $w \in L(G)$ y visto así, el \textit{AST} se trata justamente del árbol de derivación de $w$, por lo que es fácil de obtener a partir de la secuencia de reglas aplicadas por el \textit{Parser} para reducir $w$ al axioma $S$.

    Está secuencia de reglas se llama el \textit{parse} de un programa, y los próximos apartados se centran en como hallarlo.
...
\textbf{7} & &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  & s25 &  &  &  &  &  &  &  &  &  &  &  \\
\hline
\textbf{8} & r28 & r28 &  &  &  &  &  &  & r28 & r28 & r28 & r28 & r28 &  &  &  &  &  & r28 &  &  &  &  &  &  &  & r28 &  &  &  &  &  &  &  & r28 \\
\hline
\textbf{9} & &  &  &  &  &  &  &  &  &  &  &  &  & s30 & s29 & s32 & s33 & s31 & s28 &  &  &  & r16 & s34 &  &  &  & s37 & s38 &  &  & s36 &  &  &  \\
\hline
\textbf{10} & &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  & s44 &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  \\
\hline
\textbf{11} & &  &  &  &  &  &  &  &  &  &  &  &  & s30 & s29 & s32 & s33 & s31 & s28 &  &  &  &  & s34 &  &  &  & s37 & s38 &  &  & s36 &  &  &  \\
\hline
\textbf{12} & &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  & s48 & s47 &  &  & s46 &  &  &  &  &  &  &  &  &  &  &  \\
\hline
\textbf{13} & &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  & r2 \\
\hline
\textbf{14} & &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  & r3 \\
...
\textbf{22} & &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  & r22 &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  \\
\hline
\textbf{23} & s7 & s5 &  &  &  &  &  &  & s6 &  & s9 & s10 & s11 &  &  &  &  &  & s12 &  &  &  &  &  &  &  & r4 &  &  &  &  &  &  &  &  \\
\hline
\textbf{24} & &  &  & s22 & s21 & s19 & s20 &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  \\
\hline
\textbf{25} & &  &  &  &  &  &  &  &  &  &  &  &  & s30 & s29 & s32 & s33 & s31 & s28 &  &  &  &  & s34 &  &  &  & s37 & s38 &  &  & s36 &  &  &  \\
\hline
\textbf{26} & &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  & r17 &  &  &  &  &  &  &  & s55 &  &  &  &  \\
\hline
\textbf{27} & &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  & s56 &  &  &  &  &  &  &  &  &  &  &  &  \\
\hline
\textbf{28} & &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  & r39 & r39 & s57 & r39 &  &  & r39 &  & r39 & r39 &  & r39 & r39 &  \\
\hline
\textbf{29} & &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  & r40 & r40 &  & r40 &  &  & r40 &  & r40 & r40 &  & r40 & r40 &  \\
\hline
\textbf{30} & &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  & r41 & r41 &  & r41 &  &  & r41 &  & r41 & r41 &  & r41 & r41 &  \\
\hline
\textbf{31} & &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  & r42 & r42 &  & r42 &  &  & r42 &  & r42 & r42 &  & r42 & r42 &  \\
\hline
\textbf{32} & &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  & r43 & r43 &  & r43 &  &  & r43 &  & r43 & r43 &  & r43 & r43 &  \\
\hline
\textbf{33} & &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  & r44 & r44 &  & r44 &  &  & r44 &  & r44 & r44 &  & r44 & r44 &  \\
\hline
\textbf{34} & &  &  &  &  &  &  &  &  &  &  &  &  & s30 & s29 & s32 & s33 & s31 & s28 &  &  &  &  & s34 &  &  &  & s37 & s38 &  &  & s36 &  &  &  \\
\hline
\textbf{35} & &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  & r47 & r47 &  & r47 &  &  & r47 &  & r47 & r47 &  & r47 & r47 &  \\
\hline
\textbf{36} & &  &  &  &  &  &  &  &  &  &  &  &  & s30 & s29 & s32 & s33 & s31 & s28 &  &  &  &  & s34 &  &  &  & s37 & s38 &  &  & s36 &  &  &  \\
\hline
\textbf{37} & &  &  &  &  &  &  &  &  &  &  &  &  & s30 & s29 & s32 & s33 & s31 & s28 &  &  &  &  & s34 &  &  &  & s37 & s38 &  &  & s36 &  &  &  \\
\hline
\textbf{38} & &  &  &  &  &  &  &  &  &  &  &  &  & s30 & s29 & s32 & s33 & s31 & s28 &  &  &  &  & s34 &  &  &  & s37 & s38 &  &  & s36 &  &  &  \\
\hline
\textbf{39} & &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  & r51 & r51 &  & r51 &  &  & r51 &  & r51 & r51 &  & r51 & r51 &  \\
\hline
\textbf{40} & &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  & r53 & r53 &  & r53 &  &  & r53 &  & s62 & r53 &  & r53 & r53 &  \\
\hline
\textbf{41} & &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  & r55 & r55 &  & r55 &  &  & s63 &  &  & r55 &  & r55 & r55 &  \\
\hline
\textbf{42} & &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  & r57 & r57 &  & r57 &  &  &  &  &  & r57 &  & s64 & r57 &  \\
\hline
\textbf{43} & &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  & r59 & r59 &  & r59 &  &  &  &  &  & r59 &  &  & s65 &  \\
\hline
\textbf{44} & &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  & s66 &  &  &  &  &  &  &  &  &  &  &  &  \\
\hline
\textbf{45} & &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  & s67 &  &  &  &  &  &  &  & s55 &  &  &  &  \\
\hline
\textbf{46} & &  &  &  &  &  &  &  &  &  &  &  &  & s30 & s29 & s32 & s33 & s31 & s28 &  &  &  &  & s34 & r31 &  &  & s37 & s38 &  &  & s36 &  &  &  \\
\hline
\textbf{47} & &  &  &  &  &  &  &  &  &  &  &  &  & s30 & s29 & s32 & s33 & s31 & s28 &  &  &  &  & s34 &  &  &  & s37 & s38 &  &  & s36 &  &  &  \\
\hline
\textbf{48} & &  &  &  &  &  &  &  &  &  &  &  &  & s30 & s29 & s32 & s33 & s31 & s28 &  &  &  &  & s34 &  &  &  & s37 & s38 &  &  & s36 &  &  &  \\
\hline
\textbf{49} & &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  & r13 &  &  &  &  &  &  &  &  &  &  &  \\
\hline
\textbf{50} & &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  & s72 &  &  &  &  &  &  &  &  &  &  &  \\
\hline
\textbf{51} & s7 & s5 &  &  &  &  &  &  & s6 &  & s9 & s10 & s11 &  &  &  &  &  & s12 &  &  &  &  &  &  &  & r4 &  &  &  &  &  &  &  &  \\
\hline
\textbf{52} & &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  & s75 &  &  &  &  &  &  &  &  \\
\hline
\textbf{53} & &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  & s76 &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  \\
...
\begin{table}[H]
    \fontsize{6.4}{9.6}\selectfont
    \setlength{\tabcolsep}{1.0pt}
    \begin{longtable}{|c|c|c|c|c|c|c|c|c|c|c|c|c|c|c|c|c|c|c|c|c|c|c|c|c|c|c|c|c|c|c|c|c|c|c|c|}
\hline
\textbf{55} & &  &  &  &  &  &  &  &  &  &  &  &  & s30 & s29 & s32 & s33 & s31 & s28 &  &  &  &  & s34 &  &  &  & s37 & s38 &  &  & s36 &  &  &  \\
\hline
\textbf{56} & r33 & r33 &  &  &  &  &  &  & r33 & r33 & r33 & r33 & r33 &  &  &  &  &  & r33 &  &  &  &  &  &  &  & r33 &  &  &  &  &  &  &  & r33 \\
\hline
\textbf{57} & &  &  &  &  &  &  &  &  &  &  &  &  & s30 & s29 & s32 & s33 & s31 & s28 &  &  &  &  & s34 & r31 &  &  & s37 & s38 &  &  & s36 &  &  &  \\
\hline
\textbf{58} & &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  & s80 &  &  &  &  &  & s55 &  &  &  &  \\
\hline
\textbf{59} & &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  & r48 & r48 &  & r48 &  &  & r48 &  & r48 & r48 &  & r48 & r48 &  \\
\hline
\textbf{60} & &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  & r49 & r49 &  & r49 &  &  & r49 &  & r49 & r49 &  & r49 & r49 &  \\
\hline
\textbf{61} & &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  & r50 & r50 &  & r50 &  &  & r50 &  & r50 & r50 &  & r50 & r50 &  \\
\hline
\textbf{62} & &  &  &  &  &  &  &  &  &  &  &  &  & s30 & s29 & s32 & s33 & s31 & s28 &  &  &  &  & s34 &  &  &  & s37 & s38 &  &  & s36 &  &  &  \\
\hline
\textbf{63} & &  &  &  &  &  &  &  &  &  &  &  &  & s30 & s29 & s32 & s33 & s31 & s28 &  &  &  &  & s34 &  &  &  & s37 & s38 &  &  & s36 &  &  &  \\
\hline
\textbf{64} & &  &  &  &  &  &  &  &  &  &  &  &  & s30 & s29 & s32 & s33 & s31 & s28 &  &  &  &  & s34 &  &  &  & s37 & s38 &  &  & s36 &  &  &  \\
\hline
\textbf{65} & &  &  &  &  &  &  &  &  &  &  &  &  & s30 & s29 & s32 & s33 & s31 & s28 &  &  &  &  & s34 &  &  &  & s37 & s38 &  &  & s36 &  &  &  \\
\hline
\textbf{66} & r34 & r34 &  &  &  &  &  &  & r34 & r34 & r34 & r34 & r34 &  &  &  &  &  & r34 &  &  &  &  &  &  &  & r34 &  &  &  &  &  &  &  & r34 \\
\hline
\textbf{67} & r35 & r35 &  &  &  &  &  &  & r35 & r35 & r35 & r35 & r35 &  &  &  &  &  & r35 &  &  &  &  &  &  &  & r35 &  &  &  &  &  &  &  & r35 \\
\hline
\textbf{68} & &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  & s85 &  &  & r29 &  &  &  &  &  & s55 &  &  &  &  \\
\hline
\textbf{69} & &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  & s87 &  &  &  &  &  &  &  &  &  &  \\
\hline
\textbf{70} & &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  & s88 &  &  &  &  &  &  &  & s55 &  &  &  &  \\
...
\textbf{75} & &  & s94 &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  \\
\hline
\textbf{76} & &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  & s96 & s95 &  & s97 &  &  &  &  &  &  &  &  &  &  &  &  \\
\hline
\textbf{77} & &  &  &  &  &  &  &  &  &  & s9 & s10 & s11 &  &  &  &  &  & s12 &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  \\
\hline
\textbf{78} & &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  & r60 & r60 &  & r60 &  &  &  &  &  & r60 &  &  & s65 &  \\
\hline
\textbf{79} & &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  & s99 &  &  &  &  &  &  &  &  &  &  \\
\hline
\textbf{80} & &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  & r45 & r45 &  & r45 &  &  & r45 &  & r45 & r45 &  & r45 & r45 &  \\
\hline
\textbf{81} & &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  & r52 & r52 &  & r52 &  &  & r52 &  & r52 & r52 &  & r52 & r52 &  \\
\hline
\textbf{82} & &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  & r54 & r54 &  & r54 &  &  & r54 &  & s62 & r54 &  & r54 & r54 &  \\
\hline
\textbf{83} & &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  & r56 & r56 &  & r56 &  &  & s63 &  &  & r56 &  & r56 & r56 &  \\
\hline
\textbf{84} & &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  & r58 & r58 &  & r58 &  &  &  &  &  & r58 &  & s64 & r58 &  \\
\hline
\textbf{85} & &  &  &  &  &  &  &  &  &  &  &  &  & s30 & s29 & s32 & s33 & s31 & s28 &  &  &  &  & s34 &  &  &  & s37 & s38 &  &  & s36 &  &  &  \\
\hline
\textbf{86} & &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  & r32 &  &  &  &  &  &  &  &  &  &  \\
\hline
\textbf{87} & &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  & s101 &  &  &  &  &  &  &  &  &  &  &  &  \\
\hline
\textbf{88} & r37 & r37 &  &  &  &  &  &  & r37 & r37 & r37 & r37 & r37 &  &  &  &  &  & r37 &  &  &  &  &  &  &  & r37 &  &  &  &  &  &  &  & r37 \\
\hline
\textbf{89} & r38 & r38 &  &  &  &  &  &  & r38 & r38 & r38 & r38 & r38 &  &  &  &  &  & r38 &  &  &  &  &  &  &  & r38 &  &  &  &  &  &  &  & r38 \\
\hline
\textbf{90} & &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  & r8 &  &  &  &  &  &  &  &  &  &  \\
\hline
\textbf{91} & &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  & s102 &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  \\
...
\textbf{92} & &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  & s103 &  &  &  &  &  &  &  &  &  &  \\
\hline
\textbf{93} & s7 & s5 &  &  &  &  &  &  & s6 &  & s9 & s10 & s11 &  &  &  &  &  & s12 &  &  &  &  &  &  &  & r4 &  &  &  &  &  &  &  &  \\
\hline
\textbf{94} & &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  & s105 &  &  &  &  &  &  &  &  &  &  &  \\
\hline
\textbf{95} & &  &  &  &  &  &  &  &  &  &  &  &  & s30 & s29 & s32 & s33 & s31 & s28 &  &  &  &  & s34 &  &  &  & s37 & s38 &  &  & s36 &  &  &  \\
\hline
\textbf{96} & &  &  &  &  &  &  &  &  &  &  &  &  & s30 & s29 & s32 & s33 & s31 & s28 &  &  &  &  & s34 &  &  &  & s37 & s38 &  &  & s36 &  &  &  \\
\hline
\textbf{97} & r26 & r26 &  &  &  &  &  &  & r26 & r26 & r26 & r26 & r26 &  &  &  &  &  & r26 &  &  &  &  &  &  &  & r26 &  &  &  &  &  &  &  & r26 \\
\hline
\textbf{98} & r27 & r27 &  &  &  &  &  &  & r27 & r27 & r27 & r27 & r27 &  &  &  &  &  & r27 &  &  &  &  &  &  &  & r27 &  &  &  &  &  &  &  & r27 \\
\hline
\textbf{99} & &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  & r46 & r46 &  & r46 &  &  & r46 &  & r46 & r46 &  & r46 & r46 &  \\
\hline
\textbf{100} & &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  & s85 &  &  & r29 &  &  &  &  &  & s55 &  &  &  &  \\
\hline
\textbf{101} & r36 & r36 &  &  &  &  &  &  & r36 & r36 & r36 & r36 & r36 &  &  &  &  &  & r36 &  &  &  &  &  &  &  & r36 &  &  &  &  &  &  &  & r36 \\
\hline
\textbf{102} & &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  & s109 &  &  & r6 &  &  &  &  &  &  &  &  &  &  \\
\hline
\textbf{103} & &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  & r12 &  &  &  &  &  &  &  &  &  \\
...
\textbf{104} & &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  & s111 &  &  &  &  &  &  &  &  \\
\hline
\textbf{105} & &  &  &  &  &  &  &  &  &  &  &  &  & s30 & s29 & s32 & s33 & s31 & s28 &  &  &  &  & s34 &  &  &  & s37 & s38 &  &  & s36 &  &  &  \\
\hline
\textbf{106} & &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  & s113 &  &  &  &  &  &  &  & s55 &  &  &  &  \\
\hline
\textbf{107} & &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  & s114 &  &  &  &  &  &  &  & s55 &  &  &  &  \\
...
\textbf{110} & &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  & r9 &  &  &  &  &  &  &  &  &  &  \\
\hline
\textbf{111} & r15 & r15 &  &  &  &  &  &  & r15 & r15 & r15 & r15 & r15 &  &  &  &  &  & r15 &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  & r15 \\
\hline
\textbf{112} & &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  & s116 &  &  &  &  &  & s55 &  &  &  &  \\
\hline
\textbf{113} & r24 & r24 &  &  &  &  &  &  & r24 & r24 & r24 & r24 & r24 &  &  &  &  &  & r24 &  &  &  &  &  &  &  & r24 &  &  &  &  &  &  &  & r24 \\
\hline
\textbf{114} & r25 & r25 &  &  &  &  &  &  & r25 & r25 & r25 & r25 & r25 &  &  &  &  &  & r25 &  &  &  &  &  &  &  & r25 &  &  &  &  &  &  &  & r25 \\
\hline
\textbf{115} & &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  & s117 &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  \\
\hline
\textbf{116} & &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  & s118 &  &  &  &  &  &  &  &  &  &  &  &  \\
...
\textbf{117} & &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  & s109 &  &  & r6 &  &  &  &  &  &  &  &  &  &  \\
\hline
\textbf{118} & r23 & r23 &  &  &  &  &  &  & r23 & r23 & r23 & r23 & r23 &  &  &  &  &  & r23 &  &  &  &  &  &  &  & r23 &  &  &  &  &  &  &  & r23 \\
\hline
\textbf{119} &  &  &  & &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  & r7 &  &  &  &  &  &  &  &  &  &  \\
\hline
        \end{longtable}
...
\hline
& $\mathbf{E_1}$ & $\mathbf{R_1}$ & $\mathbf{R_2}$ & $\mathbf{U_1}$ & $\mathbf{U_2}$ & $\mathbf{E_2}$ & $\mathbf{V}$ & $\mathbf{S}$ & $\mathbf{L}$ & $\mathbf{Q}$ & $\mathbf{X}$ & $\mathbf{B}$ & $\mathbf{T}$ & $\mathbf{M}$ & $\mathbf{F}$ & $\mathbf{F_1}$ & $\mathbf{F_2}$ & $\mathbf{F_3}$ & $\mathbf{H}$ & $\mathbf{A}$ & $\mathbf{K}$ & $\mathbf{C}$ & $\mathbf{P}$ \\
\hline
\textbf{0} & &  &  &  &  &  &  & 8 &  &  &  & 3 &  &  & 2 &  &  &  &  &  &  &  & 1 \\
\hline
\textbf{1} & &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  \\
...
\textbf{8} & &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  \\
\hline
\textbf{9} & 26 & 43 & 42 & 41 & 40 & 39 & 35 &  &  &  & 27 &  &  &  &  &  &  &  &  &  &  &  &  \\
\hline
\textbf{10} & &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  \\
\hline
\textbf{11} & 45 & 43 & 42 & 41 & 40 & 39 & 35 &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  \\
\hline
\textbf{12} & &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  \\
\hline
\textbf{13} & &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  \\
...
\textbf{45} & &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  \\
\hline
\textbf{46} & 68 & 43 & 42 & 41 & 40 & 39 & 35 &  & 69 &  &  &  &  &  &  &  &  &  &  &  &  &  &  \\
\hline
\textbf{47} & 70 & 43 & 42 & 41 & 40 & 39 & 35 &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  \\
\hline
\textbf{48} & 71 & 43 & 42 & 41 & 40 & 39 & 35 &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  \\
\hline
\textbf{49} & &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  \\
\hline
\textbf{50} & &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  & 73 &  &  &  &  &  \\
...
\textbf{54} & &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  \\
\hline
\textbf{55} & & 78 & 42 & 41 & 40 & 39 & 35 &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  \\
\hline
\textbf{56} & &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  \\
\hline
\textbf{57} & 68 & 43 & 42 & 41 & 40 & 39 & 35 &  & 79 &  &  &  &  &  &  &  &  &  &  &  &  &  &  \\
\hline
\textbf{58} & &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  \\
\hline
\textbf{59} & &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  \\
\hline
    ...
    \begin{table}[H]
        ...
        \begin{longtable}{|c|c|c|c|c|c|c|c|c|c|c|c|c|c|c|c|c|c|c|c|c|c|c|c|}
            ...
            \textbf{63} & &  &  &  & 82 & 39 & 35 &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  \\
            \hline
            \textbf{64} & &  &  & 83 & 40 & 39 & 35 &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  \\
            \hline
            \textbf{65} & &  & 84 & 41 & 40 & 39 & 35 &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  \\
            \hline
            \textbf{66} & &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  \\
            \hline
            \textbf{67} & &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  \\
            ...
            \textbf{84} & &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  \\
            \hline
            \textbf{85} & 100 & 43 & 42 & 41 & 40 & 39 & 35 &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  \\
            \hline
            \textbf{86} & &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  \\
            \hline
            \textbf{87} & &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  \\
            ...
            \textbf{94} & &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  \\
            \hline
            \textbf{95} & 106 & 43 & 42 & 41 & 40 & 39 & 35 &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  \\
            \hline
            \textbf{96} & 107 & 43 & 42 & 41 & 40 & 39 & 35 &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  \\
            \hline
            \textbf{97} & &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  \\
            \hline
            \textbf{98} & &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  \\
            ...
            \textbf{104} & &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  \\
            \hline
            \textbf{105} & 112 & 43 & 42 & 41 & 40 & 39 & 35 &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  \\
            \hline
            \textbf{106} & &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  \\
            \hline
            \textbf{107} & &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  &  \\
    ...
    Por ahora sólo se ha lanza un tipo de error en el \textit{Parser}\footnote{Tras implementar el Analizador Semántico, se podrán enriquecer los errores del \textit{Parser} con mayor facilidad y se añadirán más tipos.}, \textit{Token Inesperado}.
    Sin embargo, su mensaje varía según la celda en la que se lance, tomando el formato:

    \begin{center}
        \emph{"expected <opción 1>, <opción 2>, $\dots$, <opción n-1> or <opción n> before <token inesperado>"}
    \end{center}

    \renewcommand{\arraystretch}{1.0}
    \begin{table}[H]
        \caption{Listado de errores del \textit{Parser}}
        \begin{tabular}{L{0.54\linewidth} L{0.40\linewidth}}
            \toprule
            \textbf{Error} & \textbf{Severidad} \\
            \midrule
    ...
    La lista de \textit{tokens} esperados se obtiene realizando una busqueda en profundidad en las tablas por cada \textit{token} con una celda no vacía en la fila del fallo. Los \textit{tokens} que desplazan siempre serán válidos, pero hay casos en los que un \textit{token} reduce una o varias veces pero acaba terminando en error, por lo que es necesario simular cada uno de ellos hasta llegar a un desplazamiento.
